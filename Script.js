...
// CORREÇÃO: Reseta TODOS os campos (Formulário Geral e Parcelamento)
function resetarFormulario(){
    ...
    document.getElementById('input-categoria').value = ''; // Limpa categoria também
    ...
    reader.onload = function(e) {
        if(confirm("Substituir dados atuais?")) {
            try {
                ...
                atualizarTudo();
                alert("Carregado!");
                toggleConfig(); // Fecha o menu após carregar
...
function calcularSaldos() {
    ...
    document.getElementById('saldo-futuro').innerText = formatarBRL(futuro);
